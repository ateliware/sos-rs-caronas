...
from apps.ride_manager.views.ride import create_ride, my_rides, open_rides, ride_detail, ride_solicitation, ride_passenger_confirmation
...
urlpatterns = [
    ...
    path("ride/solicitation/<uuid:ride_id>", ride_solicitation, name="ride_solicitation"),
    path("ride/confirmation/<uuid:ride_id>/<uuid:passenger_id>", ride_passenger_confirmation, name="ride_passenger_confirmation"),
